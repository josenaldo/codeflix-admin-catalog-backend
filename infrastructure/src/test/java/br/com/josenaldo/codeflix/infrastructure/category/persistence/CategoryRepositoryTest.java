...
class CategoryRepositoryTest {
    ...
    public void givenAnInvalidNullName_whenCallsSave_thenShouldReturnDataIntegrityViolationException() {
        ...
        final var expectedErrorMessage = "not-null property references a null or transient value: br.com.josenaldo.codeflix.infrastructure.category.persistence.CategoryJpaEntity.name";
    ...
    public void givenAnInvalidNullCreatedAt_whenCallsSave_thenShouldReturnDataIntegrityViolationException() {
        ...
        final var expectedErrorMessage = "not-null property references a null or transient value: br.com.josenaldo.codeflix.infrastructure.category.persistence.CategoryJpaEntity.createdAt";
        final var category = Category.newCategory("Filmes", null, true);
        final var entity = CategoryJpaEntity.from(category);
    ...
    public void givenAnInvalidNullUpdatedAt_whenCallsSave_thenShouldReturnDataIntegrityViolationException() {
        ...
        final var expectedErrorMessage = "not-null property references a null or transient value: br.com.josenaldo.codeflix.infrastructure.category.persistence.CategoryJpaEntity.updatedAt";
        final var category = Category.newCategory("Filmes", null, true);
        final var entity = CategoryJpaEntity.from(category);
